...
namespace DBank.Domain.Migrations
{
    ...
    [Migration("20250208095118_Modified UserEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBank.Domain.Entities.CardEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DBank.Domain.Entities.TransactionEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DBank.Domain.Entities.CardEntity", b =>
                {
                    b.HasOne("DBank.Domain.Entities.CustomerEntity", "Customer")
                        .WithOne("Card")
                        .HasForeignKey("DBank.Domain.Entities.CardEntity", "CustomerId");
            ...
            modelBuilder.Entity("DBank.Domain.Entities.CustomerEntity", b =>
                {
                    b.HasOne("DBank.Domain.Entities.UserEntity", "User")
                        .WithOne("Customer")
                        .HasForeignKey("DBank.Domain.Entities.CustomerEntity", "UserId");
